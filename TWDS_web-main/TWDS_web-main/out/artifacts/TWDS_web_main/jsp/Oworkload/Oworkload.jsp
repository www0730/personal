...
<script type="text/javascript">
	...
	function updateOworkload(){
		...
		function update(){
			var row=$("#dg").datagrid("getSelected");//getselect只能获取一组选中数据
			var oid=$("#oid").val();
			var otype=$("#otype").val();
	...
	<table id="dg" class="easyui-datagrid" border="false"  data-options="pagination:true,fitColumns:true,singleSelect:true" >
		...
		<c:if test="${list.size()==0}">
				<div class="easyui-window" title="提示" style="width:200px;height:130px;text-align: center;">
					<span>暂无数据！</span></br>
					<a href="${pageContext.request.contextPath}/Oworkload/insertView.action"  class="easyui-linkbutton" style="width:100px;margin-top: 20px;" iconCls="icon-add">添加</a>
