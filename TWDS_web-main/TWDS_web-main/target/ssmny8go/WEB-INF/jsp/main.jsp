...
<div data-options="region:'north',split:true" style="height:90px;background:linear-gradient(#4169E1,#fff);border-radius: 5px;" >
	<h1 class="title" style="color: white;">教师工作量核算系统</h1>
	<p class="title-username">欢迎您!  &nbsp; <span style="color: blue;"><%=session.getAttribute("name")%></span><span>&nbsp;&nbsp;${role.level}&nbsp;&nbsp;</span> <a href="logout.action" class="easyui-linkbutton" >注销</a>
	...
	<ul class="easyui-tree"  data-options="lines:true">
		<c:if test="${role.roleid==4||role.roleid==3}">
			<li data-options="state:'closed'">
				<span>工作量申报管理</span>
				<ul>
					<li><a href="javascript:void(0)" onclick="addTabs('教学工作量申报','tCourses/selectAllCourses')" >教学工作量申报</a></li>
			...
			-<li data-options="state:'closed'">
				...
				<ul>
					...
					<%--<li><a href="javascript:void(0)" onclick="addTabs('工作量汇总','examines/MoAllWorkLoad')" >工作量汇总</a></li>--%>
				</ul>
			</li>-
		...
		<c:if test="${role.roleid==2||role.roleid==3}">
			...
			<%--	<li data-options="state:'closed'">
					...
					<ul>
						...
						<li><a href="javascript:void(0)" onclick="addTabs('教师科研工作量汇总','tCourses/selectAllTworkload')">教师科研工作量汇总</a></li>
